...
def main():
    st.title("Prediction of channel dimensionality in extra-large pore zeolite")
    html_temp = """
    ...
    <h1 style ="color:black;text-align:center; font-size: 10px;">
     ...
     (5) Prediction- If output is : [0]- Small/medium/large pore zeolite, [1] - one dimensional channel in extra large pore zeolites, [2] -Two dimensional channel in extra large pore zeolites, [3] - Three dimensional channel in extra large pore zeolites</h1>
    </div>
    """
